...
public class ExceptonController extends Controller {
    ...
    public ModelAndView noHandlerFoundException(final Context context, final Exception e) {
        return mav(context, e, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(UnknownPostException.class)
    public ModelAndView unknownPostException(final Context context, final Exception e) {
        return mav(context, e, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(UnknownUserException.class)
    public ModelAndView unknownUserException(final Context context, final Exception e) {
        return mav(context, e, HttpStatus.NOT_FOUND);
    }
