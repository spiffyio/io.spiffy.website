...
public class HashStringCall extends SpiffyCall<PostStringInput, PostOutput> {

    private static final String PATH = "security/hashstring";

    @Inject
    public HashStringCall(final WebTarget target, final MemcachedClient client) {
